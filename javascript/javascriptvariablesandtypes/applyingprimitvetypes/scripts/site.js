...
function loadApplication() {
    ...
    if (la != undefined) {
        ...
        //You can't take less variable from array and you can also give default value
     //   var [isEmployed,hasKids=true,hasLoans] = la.Factors;

     //You can't take less variable if you don't know the left paramter then ...arrayArgs are able to handle
     //var [isEmployed,hasKids,hasLoans,hasCreditcards,...arrayArgs] = la.Factors;

     //Destructing Object
     //var {Id:a,ApplicantName:b}=la;
     var {Id,ApplicantName="Deepak"}=la;
...
function generateRickProfile(la) {
    ...
    var phd1 = nameAndTitle.startsWith("ph.d");
    var md = nameAndTitle.endsWith("md");
    var md1= nameAndTitle.endsWith("m.d");
...
Loan Applied for ${"$"+la.LoanAmount}
